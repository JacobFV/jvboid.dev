...
date: 2015-03-01
resume_description: "full-stack 36x36 sheet-metal CNC cutter with c# svg parser and toolpath scheduler plus an arduino client over a serial protocol. c#, arduino, svg parsing, electronics, diy hardware, school project."
endDate: 2015-05-29
lane: building
tags: [personal]
summary: "Full stack engineering project"
hero: 
  src: /img/migrated/cc_1.jpg
  alt: "Cookie Cutter CNC"
links: 
  github: https://github.com/JacobFV/CookieControl
  demo: https://jacobfv123.medium.com/cookie-cutter-cnc-923c68932ee6
---
...
- [Plasma cutter demonstration cutting aluminum foil](https://www.youtube.com/watch?v=ENCtb-QoQ5s)
- [Presented](https://www.youtube.com/watch?v=yGfpX0WXYFM&t=9s) in Mrs. Kline's 9th grade human geography class (so cringe :lol:)
- [Mock product release video](https://www.youtube.com/watch?v=dyWwv9mZEvk), used in the class presentation above
...
In honor of an attempted 3D printer, the [Cookie Baker](/projects/cookie-baker-3d-printer), I named this machine the Cookie Cutter. This system has all the bare-bones you would expect from a sheet metal cutting CNC except for an actual working cutting head. It uses CookieWare to read SVG files, an Arduino Mega with CookieWare Client to buffer serial input and make appropriate movements, and a threadscrew XY table. Check out the CookieCutter's Github repos for [server](https://github.com/JacobFV/CookieControl) and [client](https://github.com/JacobFV/Arduino-CookieControl) code.

## Media Archive

- [Plasma cutter demonstration cutting aluminum foil](https://www.youtube.com/watch?v=ENCtb-QoQ5s)
- [Presentation in Mrs. Kline's 9th grade human geography class](https://www.youtube.com/watch?v=yGfpX0WXYFM&t=9s) (so cringe :lol:)
- [The actual product release video](https://www.youtube.com/watch?v=dyWwv9mZEvk), which was used in the presentation above
