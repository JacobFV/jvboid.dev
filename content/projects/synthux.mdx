...
title: "SynthUX"
date: 2026-05-23
resume_description: "low-compute synthetic computer-use dataset generator that expands goals into grammar trees and replays them as low-level input in browser desktop simulators. python, node tree grammars, svelte simulators, hugging face datasets."
lane: building
unlisted: true
