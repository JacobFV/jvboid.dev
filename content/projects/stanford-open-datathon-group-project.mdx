...
date: 2021-04-12
resume_description: "datathon research project analyzing covid vaccine misinformation and twitter sentiment via clustering of bert tweet embeddings. python, bert, k-means, hypertools, 5-person group project."
lane: building
tags: [community]
summary: "Data scientist in a 5-student international group"
hero: 
  src: /img/migrated/covid_7.png
  alt: "Stanford Open Datathon Group Project"
links: 
  github: https://github.com/jennarsimon/sodp-team114
---
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_1.png" alt="Density plot of COVID-vaccine tweet sentiment for the unbiased sample, spiking sharply at zero"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_2.png" alt="Spread of COVID-vaccine tweet sentiment for the unbiased sample, showing the positive interquartile range and the outliers outside the narrow center"/>
    </div>
</div>
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_3.png" alt="Sentiment distribution with the -0.05 to 0.05 band excluded, shifting the central tendency upward"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_4.png" alt="Spread of the same center-excluded sample, showing the accentuated skew and the few remaining outliers"/>
    </div>
</div>
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_5.png" alt="Distribution of strictly negative sentiment (x <= -0.05), centered near -0.31"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_6.png" alt="Spread of the strictly negative sentiment subset"/>
    </div>
</div>
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_7.png" alt="Raw mean COVID-vaccine tweet sentiment over 13-18 August 2020, oscillating between roughly -0.9 and -0.4"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_8.png" alt="Savgol-smoothed (window 51, polyorder 3) mean sentiment over the same window, showing the oscillatory trend more clearly"/>
    </div>
</div>
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_9.png" alt="3D hypertools plot of k-means clusters over BERT last-token tweet embeddings, k=10"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_10.png" alt="3D hypertools plot of k-means clusters over BERT embeddings pooled across the final layer, k=10"/>
    </div>
</div>
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_11.png" alt="3D k-means clusters for the disjoint subset (index 400-999), last-token embeddings, k=10"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="/img/migrated/covid_12.png" alt="3D k-means clusters for the disjoint subset (index 400-999), pooled embeddings, k=10"/>
    </div>
</div>
