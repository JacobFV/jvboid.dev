...
date: 2019-02-01
resume_description: "research proposal for human-level AI via unsupervised GLOM-style agents that each control a sandboxed linux vm and evolve under artificial selection on information tasks. python, tensorflow, deep reinforcement learning, research."
lane: building
tags: [ai, deep-learning, reinforcement-learning, research, tensorflow]
summary: "Computer interaction + deep reinforcement learning"
links: 
