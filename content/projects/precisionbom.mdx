...
status: active
tags: [work]
summary: "An AI-powered BOM sourcing platform that combines specialist agents, real supplier data, and blockchain-backed audit trails for hardware procurement."
links: 
