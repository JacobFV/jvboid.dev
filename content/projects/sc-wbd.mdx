...
Those four numbers are not a summary written for this page. They are the front
page of the model's own site, which publishes the zero in the same size as the
parameter count and turns the connectome with the mouse:

<LiveDemo
  url="https://sc-wbd.pages.dev"
  title="SC-WBD"
  caption="sc-wbd.pages.dev — the running statement of what each checkpoint measured, and the 414-region prior you can turn."
/>
