...
date: 2026-05-25
resume_description: "firmware that makes a seeed xiao esp32s3 sense enumerate as a standard usb video class webcam streaming mjpeg over native usb, seen on linux as a normal /dev/video node. esp-idf, platformio, c, usb uvc, embedded hardware."
lane: building
