...
date: 2026-04-05
resume_description: "a type system for multimodal latent dynamics that turns frozen video diffusion backbones into structured world-modeling substrates via declared latent regions and looped attention. python, diffusion transformers, world models, research."
lane: building
tags: []
summary: "A type system for multimodal latent dynamics that turns video diffusion models into structured world-modeling substrates."
hero: 
  src: https://raw.githubusercontent.com/JacobFV/canvas-engineering/main/assets/canvas_layouts_combined.png
  alt: canvas-engineering
threadImages:
  - src: https://raw.githubusercontent.com/JacobFV/canvas-engineering/main/assets/canvas_layouts_combined.png
    alt: Canvas engineering layouts
  - src: https://raw.githubusercontent.com/JacobFV/canvas-engineering/main/assets/canvas_type_system.png
    alt: Canvas engineering type system
  - src: https://raw.githubusercontent.com/JacobFV/canvas-engineering/main/assets/topology_constructors.png
    alt: Canvas topology constructors
  - src: https://raw.githubusercontent.com/JacobFV/canvas-engineering/main/assets/looped_attention.png
    alt: Looped attention diagram
links: 
