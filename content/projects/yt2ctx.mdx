...
title: yt2ctx
date: 2026-05-21
resume_description: "youtube-to-context compiler that turns reference videos into transcripts, representative frames, style bibles, shot specs, agent prompts, and zip artifacts. next.js, react, typescript, openai, yt-dlp, ffmpeg, vercel blob, postgres, mcp."
lane: building
...
icon:
  src: "/assets/img/projects/yt2ctx-icon.svg"
  alt: "yt2ctx favicon"
threadImages:
  - src: "/assets/img/projects/yt2ctx-landing.png"
    alt: "yt2ctx web app showing the Reference Monograph analyzer interface"
...
<LiveDemo
  url="https://yt2ctx.vercel.app/"
  title="yt2ctx"
  caption="The Reference Monograph running here — paste a YouTube link and watch the analyzer stream a context pack."
/>
