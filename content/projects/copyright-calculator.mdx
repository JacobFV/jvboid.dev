...
date: 2014-09-16
resume_description: "scripted conversation web app that queries students to determine whether reused material qualifies for fair use. html, css, javascript, google sites, group school project."
lane: building
tags: [school]
summary: "Scripted conversation bot to help students stay safe"
hero: 
  src: /img/migrated/copyright_calculator.png
  alt: "Copyright Calculator"
links: 
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
      <img src="/img/migrated/copyright_calculator.png" alt="Copyright Calculator Homepage" className="img-fluid rounded z-depth-1" />
    </div>
    <div className="col-sm mt-3 mt-md-0">
      <img src="/img/migrated/copyright_orig.png" alt="Copyright Calculator Advisor" className="img-fluid rounded z-depth-1" />
    </div>
</div>
