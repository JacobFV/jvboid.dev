...
date: 2026-03-24
resume_description: "event-sourced multi-scale cognitive control system for autonomous gui agents, where belief is a projection over an event log. python, event sourcing, research."
lane: research
...
influences: [computatrum, windows-web-next]
realizes: []
critiques: []
---
...
- **Targets:** autonomous GUI agents working in the windows-web-next / macos-web-next environments.

## Results
Active research. Pairs with [`windows-web-next`](/projects/windows-web-next) and [`macos-web-next`](/projects/macos-web-next) as the cognitive layer above the controllable-desktop environment.
