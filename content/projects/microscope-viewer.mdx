...
date: 2026-05-28
resume_description: "electron viewer that streams a non-UVC usb microscope by driving its vendor-specific supercamera protocol over a small python usb bridge. electron, python, usb, jpeg streaming, hardware."
lane: building
