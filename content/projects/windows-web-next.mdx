---
title: windows-web-next
date: 2026-02-01
resume_description: "browser-based windows 11 simulation with window manager, virtual filesystem, and bundled apps for human annotation and computer-use agent research. svelte, typescript, vercel."
lane: building
tags: [work]
summary: "A browser-based Windows 11 simulation built for human annotation and computer-use agent research."
icon:
  src: "/assets/img/projects/windows-web-next-favicon.svg"
  alt: "windows-web-next favicon"
# Thumbnail mosaic: the app icon plus three screen recordings of the
# simulator actually being driven. Recorded off the live deploy.
threadImages:
  - src: "/assets/img/projects/windows-web-next-favicon.svg"
    alt: "windows-web-next app icon"
  - src: "/assets/img/projects/windows-web-next-start.gif"
    alt: "The Start menu opening and taking a search query"
  - src: "/assets/img/projects/windows-web-next-explorer.gif"
    alt: "File Explorer walking the in-memory filesystem"
  - src: "/assets/img/projects/windows-web-next-terminal.gif"
    alt: "The bundled PowerShell listing a directory"
links: 
  github: https://github.com/JacobFV/windows-web-next
  demo: https://windows-web-next.vercel.app
---

<FluentAtmosphere />

<LiveDemo
  url="https://windows-web-next.vercel.app"
  title="windows-web-next"
  caption="The simulator running here — open apps, move windows, and browse the in-memory filesystem."
/>
...
Repo: [JacobFV/windows-web-next](https://github.com/JacobFV/windows-web-next)
