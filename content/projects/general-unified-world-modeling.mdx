...
date: 2026-02-01
resume_description: "typed causal ontology of civilization that projects economics, politics, firms, people, and events onto one structured latent world model with 857 fields for cross-domain forecasting. python, world models, structured latent inference, research."
lane: building
tags: [world-modeling, structured-latents, ai, research, python]
summary: "A typed causal ontology of civilization that projects economics, politics, firms, people, and events onto one structured latent world model."
hero: 
  src: https://raw.githubusercontent.com/JacobFV/general-unified-world-modeling/develop/docs/assets/canvas_full_world.png
  alt: general-unified-world-modeling
links: 
...
## Projection and partial supervision
