...
title: MPNets
date: 2022-01-30
resume_description: "graph-based neural architecture experiment for training one policy across supervised, self-supervised, unsupervised, reinforcement, hebbian, feedback, and structural learning signals. python, graph executor, research."
lane: building
tags: [ai, research]
