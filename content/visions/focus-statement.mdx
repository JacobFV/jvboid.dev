...
lane: personal
tags: [bio]
summary: "We're witnessing the greatest technoevolutionary leap in the history of the observable universe. Yes, we might retrospectively say we were living in a fast-ish takeoff. Everything Everywhere All at Once. And most people don't even realize it! But what's a takeoff when only a m…"
sceneId: focus-statement
hero: 
  src: /img/migrated/focus-statement.png
  alt: "Focus Statement"
influences: []
realizes: []
critiques: []
...
To make this vision a reality, I first need to finish the prototype. I'm integrating the separate subsystems now, and will have a fully-assembled prototype soon. I also need to raise money to finance the fabrication equiptment and train the kinesthetic models. Looking in the range 100k-1M [if you're interested](/contact). Aiming to launch early 2024.
