...
This is a companion to the empirical ROAM paper on [looped attention](/assets/pdf/roam/looped-attention-video-diffusion-transformers.pdf); where that work asks *what works and why* in the video-diffusion substrate, this one asks *how to make latent structure declarable at all*, and argues that declared structure — versionable, diffable, compilable, shareable — is the production-ready on-ramp to intuition-guided symbolic world modeling.
