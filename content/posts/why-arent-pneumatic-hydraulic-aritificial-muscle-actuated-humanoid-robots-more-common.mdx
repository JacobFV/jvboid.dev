...
lane: writing
tags: []
summary: "This was a StackExchange question i asked many years ago link and with Clone's showcase today it smells like musculoskeletal humanoid startups might be trending tomorrow. Pneumatic/hydraulic artificial muscles are attractive actuator units for several reasons: - they're much c…"
influences: []
realizes: []
critiques: []
hero:
  src: "/assets/media/limboid/lower-body-cad-05.jpg"
  alt: "CAD render of the Limboid humanoid lower body"
---
...
This post is the longform version of the question I pushed into X after Clone's showcase made musculoskeletal humanoids feel unusually live again.

<XPost
  caption="Original humanoid actuation post"
  url="https://x.com/jvboid/status/1892371399123124333"
/>
