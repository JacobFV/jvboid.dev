...
date: 2021-12-31
lane: research
tags: [experiment, reflection]
summary: "Steps I am taking to increase my productivity"
---
## The Problem
...
<div className="row justify-content-sm-center">
    <div className="col-sm-6 mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="planning the next months"/>
    </div>
    <div className="col-sm-6 mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="reviewing what I learned"/>
    </div>
</div>
<br/>
...
<div className="row justify-content-sm-center">
    <div className="col-sm-6 mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="My task list"/>
    </div>
    <div className="col-sm-6 mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="Routines I need to kill"/>
    </div>
</div>
<br/>
