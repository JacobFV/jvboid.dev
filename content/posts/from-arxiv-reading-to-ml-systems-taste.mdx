...
This is why the old [arxiv notes](/posts/arxiv-notes) still matter, even when many of the links are dated. The value was not the static list. The value was learning to keep a live index of ideas that might later become architecture, product intuition, or research taste.
