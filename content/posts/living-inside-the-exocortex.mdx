...
lane: writing
tags: []
summary: "delegation, distributed cognition, exocortical identity, and the possible phenomenology of minds whose causal structure extends beyond a single egocentric stream"
---
...
These posts are smaller public markers of the same direction: better-than-frontier local workflows, the Great Automation, and the feeling that agent capability turns software and operations into leverage surfaces.

<XPost
  caption="Exocortex and automation signals"
  urls={[
