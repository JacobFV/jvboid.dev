...
critiques: []
hero:
  src: "/assets/img/block-sparse-attention-with-block-retrieval/thumbnail.jpeg"
  alt: "Block Sparse Attention With Block Retrieval"
---
...
This connects to my older interest in structured sparsity in the [brain model](/projects/brain-model) and the more speculative architectural notes in [Design Patterns for AI](/posts/design-patterns-for-ai). The recurring intuition is that topology should be part of the interface. A model should not only learn weights; it should expose useful ways to route, compress, reuse, and inspect information.
