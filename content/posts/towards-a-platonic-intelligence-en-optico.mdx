...
lane: writing
tags: []
summary: "computation en optico, the information-theoretic basis for consciousness as a computation, its representation in recurrent optical systems, and some unlocks"
---
...
<img className="img-fluid rounded z-depth-1" src="/img/migrated/diffusion-diagram.svg" alt="Optical diffusion in PHASER chamber" title="Optical diffusion in PHASER chamber"/>
